      ...
      <div className="random-movie">
        ...
        <div className="random-movie__content">
          ...
          <div className="random-movie__details-container">
            <h2 className="random-movie__movie-title">Friends with benefits</h2>
            <ul className="random-movie__information">
              ...
              <li className="random-movie__list-item-value">
                ...
                Officia, dolorum assumenda vitae voluptas error magni iusto
                perspiciatis repellat, dolor nostrum voluptatum harum nobis iure
                explicabo.
              </li>
            </ul>
          </div>
